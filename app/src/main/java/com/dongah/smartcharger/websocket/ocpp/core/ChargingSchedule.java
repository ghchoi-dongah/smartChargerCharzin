...
public class ChargingSchedule implements Validatable {
    ...
    /**
     * @deprecated use {@link #ChargingSchedule(ChargingRateUnitType, ChargingSchedulePeriod[])} to
     * be sure to set required fields.
     */
    @Deprecated
     ...
     *
     * @param chargingRateUnit       the {@link ChargingRateUnitType}, see {@link #setChargingRateUnit(ChargingRateUnitType)}
     * @param chargingSchedulePeriod arrary of {@link ChargingSchedulePeriod}, see {@link #setChargingSchedulePeriod(ChargingSchedulePeriod[])}
     */
    ...
    /**
     * Optional. Starting poiny of an absolute schedule. If absent the schedule will be relative to
     * start of charging
     *
     ...
     * smart charging algorithm to optimize the power allocation for in the case a charging process
     * is inefficient at lower charging rates. Accepted at most one digit fraction.
     *
